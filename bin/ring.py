...
def main():
    ...
    blastpy.bp_sendCommandAndWait(bp, id, "lmos", blastpy.BpCommand.kClearQpSets, 2000)
    id = id + 1
    ...
    blastpy.bp_sendMessageAndWait(bp, id, "lmos", "<command id=\"" + str(id) + "\"><qpset name=\"bp_calibration\" current=\"10.0\" speed=\"500\" frequency=\"30000\"/>2</command>", 3000)
    id = id + 1
    ...
    blastpy.bp_sendMessageAndWait(bp, 999, "lmos", "<command id=\"999\" filename=\"C:\Rofin\VisualLaserMarker\MarkingFiles\\ringtest_vlm_save.VLM\">18</command>", 3000)
