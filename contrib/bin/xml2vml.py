...
blastpy.connectToServer(blast, myconfig.WS_SERVER_REMOTE, myconfig.WS_TIMEOUT_SHORT)
...
result = blastpy.BpWaitForReplyOrTimeout(blast, result.id, myconfig.WS_TIMEOUT_LONG)
