...
\insertcode{"../../src/libblastpit/t_client_command.py"}{Python Client Example} % The first argument is the script location/filename and the second is a caption for the listing
...
%----------------------------------------------------------------------------------------
%
% Wherever possible, the code examples used here should be references to files
% that are used as part of the main test suite. This ensures that the examples
% can be relied on to work successfully.
...
\insertcode{"../../src/libblastpit/t_listening_server.py"}{Python Listening Server Example}

The same example, written in C:

\insertcode{"../../src/libblastpit/t_listening_server.c"}{C Listening Server Example}

\section{Client Example}

This example connects to the server, sends a command, and waits for a response.

\insertcode{"../../src/libblastpit/t_client_command.py"}{Python Client Example}

The equivalent C code:

\insertcode{"../../src/libblastpit/t_client_command.c"}{C Client Example}
...
\subsection{netServerNew}\index{netServerNew()}
