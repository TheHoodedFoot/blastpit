...
#define STEAMCONTROLLER_FLAG_PAD_STICK                                                                                 \
	(0x80 << 16) /**< If set, STEAM_CONTROLLER_BUTTON_LFINGER to determines whether leftXY is                      \
...
#define STEAMCONTROLLER_CONFIG_HORIZONTAL_ACCELERATION_AS_STICK                                                        \
	1 /**< Replaces left horizontal axes with X acceleration. */
#define STEAMCONTROLLER_CONFIG_VERTICAL_ACCELERATION_AS_STICK                                                          \
	2						      /**< Replaces left vertical axes with Y acceleration.    \
							       */
...
#define STEAMCONTROLLER_TIMEOUT_NEVER                                                                                  \
	0x2784 /**< Seems to be a magic value. Didn't test it, haven't got all eternity... */
...
void SCAPI SteamController_EnableGyro(const SteamControllerDevice *pDevice);
...
bool SCAPI SteamController_TriggerHaptic(const SteamControllerDevice *pDevice, uint16_t motor, uint16_t onTime,
					 uint16_t offTime, uint16_t count);
