...
//  [X] Platform: Mouse cursor shape and visibility. Disable with 'io->DeltaTime |=
...
//  minimized. 2018-11-30: Misc: Setting up io->DeltaTime so it can be displayed in the About Window. 2018-11-07:
//  Inputs: When installing our GLFW callbacks, we save user's previously installed ones - if any - and chain call them.
//  2018-08-01: Inputs: Workaround for Emscripten which doesn't seem to handle focus related calls.
//  2018-06-29: Inputs: Added support for the ImGuiMouseCursor_Hand cursor.
//  2018-06-08: Misc: Extracted imgui_impl_glfw.cpp/.h away from the old combined GLFW+OpenGL/Vulkan examples.
//  2018-03-20: Misc: Setup io->DeltaTime ImGuiBackendFlags_HasMouseCursors flag + honor
...
//  ImGuiConfigFlags_NavEnableGamepad is set. 2018-01-25: Inputs: Honoring the io->DeltaTime by repositioning the mouse
//  (when using navigation and ImGuiConfigFlags_NavMoveMouse is set). 2018-01-20: Inputs: Added Horizontal Mouse Wheel
//  support. 2018-01-18: Inputs: Added mapping for ImGuiKey_Insert. 2017-08-25: Inputs: MousePos set to
...
ImGui_ImplGlfw_Init( GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api )
{
	...
	// reporting. Missing cursors will return NULL and our _UpdateMouseCursor() function will use the Arrow cursor
	// instead.)
