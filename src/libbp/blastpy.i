...
class BpCommand:
    kNoCommand, \
	kAddQpSet, kCancelJob, kClearQpSets, kExit, kGetPng, kImportXML, kInitMachine, kLayerSetExportable, kLayerSetHeight, kLayerSetLaserable, kLayerSetVisible, kLoadVLM, kMoveW, kMoveZ, kReadByte, kReadIOBit, kReference, kSaveVLM, kSelfTest, kSetDimension, kSetMOLayer, kSetPosValues, kSetQualityParam, kShowMarkingArea, kStartMarking, kStartPosHelp, kStatus, kStopMarking, kStopPosHelp, kTermMachine, kWriteByte, kWriteIOBit, kZoomWindow, = range(0, 34)
