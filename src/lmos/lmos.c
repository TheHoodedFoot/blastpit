...
StringToBSTR( const char* string )
{
	...
	if ( bstr_string == NULL ) {
		fprintf( stderr, "SysAllocString failed in %s\n", __func__ );
		return NULL;
	}
...
main()
{
	...
	const char* xml =
		"<?xml version=\"1.0\"?><DRAWING UNIT=\"MM\"><ROOT ID=\"Blastpit\" WIDTH=\"120.0\" "
		"HEIGHT=\"120.0\"><LAYER NAME=\"bp_edd400\" HEIGHT_Z_AXIS=\"120.0\" COLOR=\"237,212,0\" /><GROUP "
		"ID=\"grect1\" USE_BOX=\"Y\" LAYER=\"bp_edd400\" LP=\"bp_edd400\" REF_POINT=\"CC\" HATCH=\"Y\" "
		"HP=\"bp_0_01\"><POLYLINE ID=\"rect1#edd400\" LAYER=\"bp_edd400\" LP=\"bp_edd400\"><POLYPOINT "
		"TYPE=\"LINE\">44.900517 69.601463</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">55.018406 "
		"69.601463</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">65.136292 69.601463</POLYPOINT><POLYPOINT "
		"TYPE=\"LINE\">75.254181 69.601463</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">75.254181 "
		"62.347126</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">75.254181 55.092788999999996</POLYPOINT><POLYPOINT "
		"TYPE=\"LINE\">75.254181 47.838454999999996</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">65.136292 "
		"47.838454999999996</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">55.018406 "
		"47.838454999999996</POLYPOINT><POLYPOINT TYPE=\"LINE\">44.900517 "
		"47.838454999999996</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">44.900517 "
		"55.092788999999996</POLYPOINT><POLYPOINT TYPE=\"BEZIER\">44.900517 62.347126</POLYPOINT><POLYPOINT "
		"TYPE=\"LINE\">44.900517 69.601463</POLYPOINT><POLYPOINT TYPE=\"LINE\">44.900517 "
		"69.601463</POLYPOINT></POLYLINE></GROUP></ROOT></DRAWING>";
