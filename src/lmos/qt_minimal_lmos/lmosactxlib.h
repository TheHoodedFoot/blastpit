/****************************************************************************
**
** Namespace LMOSACTXLib generated by dumpcpp from type library
...
class LMOSACTXLIB_EXPORT _DLMOSActX : public QAxObject
{
	...
	*/
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool ExportAsLogo( const QString& LogoName,
				  bool		 ExportEllipsesAsPolylines,
				  int		 IncrementsPerFullEllipse );
	...
	*/
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool GetBackgroundProperties( const QString& MOName,
					     bool&	    ShowFrame,
					     bool&	    DrawFrame,
	...
	*/
	inline bool GetHatchParam( const QString&		hpname,
				   LMOSACTXLib::eHSType		hstype,
				   LMOSACTXLib::eHatchParamType partype,
				   QVariant&			varVal );
	...
	*/
	inline bool GetHatchProperties( const QString& MOName,
					bool&	       Unidirectional,
					bool&	       Bidirectional,
					bool&	       Meandering,
					bool&	       OnTheFly,
	...
	*/
	inline bool GetLogoProperties( const QString& LogoName,
				       QString&	      FileName,
				       bool&	      OriginalSize,
				       double&	      xScale,
				       double&	      yScale,
	...
	*/
	inline bool GetMatrixCellProperties( const QString& MatrixName,
					     double&	    Width,
					     double&	    Height,
					     double&	    XOffset,
					     double&	    YOffset,
	...
	*/
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool GetMatrixGroupData(
		const QString& MatrixName, int Index, double& X, int& xElements, double& Y, int& yElements );
	...
	*/
	inline bool GetMatrixGroupProperties(
		const QString& MatrixName, double& X, int& xElements, double& Y, int& yElements );
	...
	*/
	inline bool GetMatrixOptionProperties( const QString& MatrixName,
					       QString&	      CustomType,
					       bool&	      ColoredCell,
					       bool&	      ShowReferenceCell,
					       bool&	      BinLayoutStatic,
					       bool&	      BinLayoutDynamic,
					       int&	      maxBin,
					       bool&	      Multiplexed );
	...
	*/
	inline bool GetPosValuesAbs(
		const QString& ObjectName, int lMatrixCellIndex, double& dX, double& dY, double& dAngle );
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool GetQPSetProperties( const QString&			    QPSetName,
					LMOSACTXLib::LMOSQPSetTypeConstants QPSetType,
					const QString&			    MOName,
					QVariant&			    PropertyNames,
					QVariant&			    PropertyValues );
	...
	*/
	inline bool GetQualityParam( const QString&	     qpname,
				     LMOSACTXLib::eQPType    qptype,
				     LMOSACTXLib::eParamType partype,
				     QVariant&		     varVal );
	...
	*/
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool GetSizePosProperties( const QString&	MOName,
					  double&		PositionX,
					  double&		PositionY,
					  double&		SizeDX,
					  double&		SizeDY,
	...
	*/
	inline bool LoadInclinedPlaneFCR( double dAlpha,
					  double dBeta,
					  double dBeamOrigin,
					  double dPlaneIntersectionOffset,
					  int	 lPlaneIntersectionOrientation,
					  int	 lHeadIndex );
	...
	*/
	inline bool MatrixAssignBinText( const QString& MatrixName,
					 int		BinNum,
					 const QString& ObjectName,
					 const QString& BinText );
	...
	*/
	inline bool MatrixQueryCellsPerPart( const QString& MatrixName,
					     int	    PartIndex,
					     int&	    CellStartIndex,
					     int&	    CellCnt );
	...
	*/
	inline bool SetHatchParam( const QString&		hpname,
				   LMOSACTXLib::eHSType		hstype,
				   LMOSACTXLib::eHatchParamType partype,
				   const QVariant&		varVal );
	...
	*/
	inline bool SetHatchProperties( const QString& MOName,
					bool	       Unidirectional,
					bool	       Bidirectional,
					bool	       Meandering,
					bool	       OnTheFly,
	...
	*/
	inline bool SetMatrixCellOffset(
		const QString& MatrixName, int iCellIndex, double OffX, double OffY, double OffPhi );
	...
	*/
	inline bool SetQualityParam( const QString&	     qpname,
				     LMOSACTXLib::eQPType    qptype,
				     LMOSACTXLib::eParamType partype,
				     const QVariant&	     varVal,
				     bool		     bSave );
	...
	*/
	...
	For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline bool TTLGetAbsPosValues(
		const QString& ObjectName, int lMatrixCellIndex, double& dX, double& dY, double& dAngle );
...
class LMOSACTXLIB_EXPORT IAxis : public QAxObject
{
	...
	*/
	...
	MoveEnd method, after MoveAxesEvent your application signals In Position with this call. Method will return
    after all moves done. For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	...
	*/
    ...
    For more information, see help context 0 in C:\Rofin\VISUAL~1\Bin\LMOSActX.hlp.
	*/
	inline void SetAxisParameter( LMOSACTXLib::eAxisType	  eAxis,
				      LMOSACTXLib::eAxisParamType eAxisParam,
				      const QVariant&		  val );
...
class LMOSACTXLIB_EXPORT ResDesc : public QAxObject
{
	...
	ResDesc( QObject* parent = 0 )
		: QAxObject( parent )
	{
		setControl( "{e61138e5-6b1b-4fa0-9c5b-5e10de8e543a}" );
	}
...
class LMOSACTXLIB_EXPORT LMOSActX : public QAxWidget
{
		...
		: QAxWidget( parent, f )
	{
		if ( licenseKey.isEmpty() ) {
			setControl( "{18213698-a9c9-11d1-a220-0060973058f6}" );
		} else {
			setControl( "{18213698-a9c9-11d1-a220-0060973058f6}:" + licenseKey );
		}
	}
...
inline LMOSACTXLib::pgResultConstants
IPowerDlg::Result() const
{
...
inline int
IPowerDlg::GetError( QString& description )
{
	int   qax_result;
...
inline bool
IPowerDlg::HandleEvent( int lEvent )
{
	bool  qax_result;
...
inline LMOSACTXLib::ILayer*
ILayers::Item( const QString& Name )
{
...
inline void
ILayer::SetExportable( bool value )
{
	setProperty( "Exportable", QVariant( value ) );
}

inline double
ILayer::FocusCorrection() const
{
...
inline void
ILayer::SetFocusCorrection( double value )
{
	setProperty( "FocusCorrection", QVariant( value ) );
}

inline double
ILayer::HeightZAxis() const
{
...
inline void
ILayer::SetHeightZAxis( double value )
{
	setProperty( "HeightZAxis", QVariant( value ) );
}

inline bool
ILayer::Laserable() const
{
...
inline void
ILayer::SetLaserable( bool value )
{
	setProperty( "Laserable", QVariant( value ) );
}
...
inline void
ILayer::SetSelectable( bool value )
{
	setProperty( "Selectable", QVariant( value ) );
}
...
inline void
ILayer::SetVisible( bool value )
{
	setProperty( "Visible", QVariant( value ) );
}
...
inline IDispatch*
_DLMOSActX::AllComponents() const
{
...
inline IDispatch*
_DLMOSActX::AllMachineCfgParams() const
{
...
inline bool
_DLMOSActX::AutoSignalJobEnd() const
{
...
inline void
_DLMOSActX::SetAutoSignalJobEnd( bool value )
{
	setProperty( "AutoSignalJobEnd", QVariant( value ) );
}

inline bool
_DLMOSActX::AutoSignalMarkingEnd() const
{
...
inline void
_DLMOSActX::SetAutoSignalMarkingEnd( bool value )
{
	setProperty( "AutoSignalMarkingEnd", QVariant( value ) );
}

inline IDispatch*
_DLMOSActX::Axis() const
{
...
inline void
_DLMOSActX::SetDummy1( int value )
{
	setProperty( "Dummy1", QVariant( value ) );
}

inline int
_DLMOSActX::Dummy2() const
{
...
inline void
_DLMOSActX::SetDummy2( int value )
{
	setProperty( "Dummy2", QVariant( value ) );
}

inline QString
_DLMOSActX::FileName() const
{
...
inline void
_DLMOSActX::SetFileName( const QString& value )
{
	setProperty( "FileName", QVariant( value ) );
}

inline IDispatch*
_DLMOSActX::GlobalVariables() const
{
...
inline void
_DLMOSActX::SetHasMatrix( bool value )
{
	setProperty( "HasMatrix", QVariant( value ) );
}

inline IDispatch*
_DLMOSActX::Layers() const
{
...
inline IDispatch*
_DLMOSActX::LocalVariables() const
{
...
inline bool
_DLMOSActX::SuppressAutoRedraw() const
{
...
inline void
_DLMOSActX::SetSuppressAutoRedraw( bool value )
{
	setProperty( "SuppressAutoRedraw", QVariant( value ) );
}

inline QString
_DLMOSActX::VLMBuildLevel() const
{
...
inline void
_DLMOSActX::ActivateZoomWindow( bool newState )
{
...
inline void
_DLMOSActX::AddGlobalQPSet( const QString& Name, double CURRENT, int SPEED, int FREQUENCY )
{
...
inline void
_DLMOSActX::AddLocalQPSet( const QString& Name, double CURRENT, int SPEED, int FREQUENCY )
{
	void* _a[] = { 0, (void*)&Name, (void*)&CURRENT, (void*)&SPEED, (void*)&FREQUENCY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 11, _a );
}
...
inline bool
_DLMOSActX::DrawingAngleOffset( double dAngle )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::DrawingGetDimension( double& dWidth, double& dHeight )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::DrawingGetPosValues( double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::DrawingPosOffset( double dX, double dY )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::DrawingSetDimension( double dWidth, double dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dWidth, (void*)&dHeight };
...
inline bool
_DLMOSActX::DrawingSetPosValues( double dX, double dY, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY, (void*)&dAngle };
...
inline void
_DLMOSActX::DriftCorr( double lambda1, double lambda2, double deltax, double deltay, int hindex )
{
...
inline void
_DLMOSActX::DriftCorrInternal( LMOSACTXLib::eHeads Head, LMOSACTXLib::eDriftModes mode )
{
...
inline bool
_DLMOSActX::ExportAsLogo( const QString& LogoName, bool ExportEllipsesAsPolylines, int IncrementsPerFullEllipse )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,
		       (void*)&LogoName,
		       (void*)&ExportEllipsesAsPolylines,
		       (void*)&IncrementsPerFullEllipse };
	qt_metacall( QMetaObject::InvokeMetaMethod, 24, _a );
	return qax_result;
}

inline bool
_DLMOSActX::ExportPl0( const QString& PL0FileName, bool bShowInitDlg )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::ExportVISFile( const QString& VISFileName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::FileName2( const QString& FName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetAxisUsedInVLM( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetBackgroundProperties( const QString& MOName,
				     bool&	    ShowFrame,
				     bool&	    DrawFrame,
				     bool&	    BackgroundBitmap,
				     QString&	    BitmapName,
...
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,	 (void*)&MOName,     (void*)&ShowFrame,	      (void*)&DrawFrame,
		       (void*)&BackgroundBitmap, (void*)&BitmapName, (void*)&BackgroundColor, (void*)&Color };
	qt_metacall( QMetaObject::InvokeMetaMethod, 30, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetDimension( const QString& ObjectName, double& dWidth, double& dHeight )
{
	bool  qax_result;
...
inline QVariant
_DLMOSActX::GetGlobalHatchSetNames()
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result };
...
inline bool
_DLMOSActX::GetGlobalQPSet( const QString& QPSetName, double& CURRENT, int& SPEED, int& FREQUENCY )
{
	bool  qax_result;
...
inline QVariant
_DLMOSActX::GetGlobalQPSetNames()
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result };
...
inline bool
_DLMOSActX::GetHatchParam( const QString&		hpname,
			   LMOSACTXLib::eHSType		hstype,
			   LMOSACTXLib::eHatchParamType partype,
			   QVariant&			varVal )
{
...
inline bool
_DLMOSActX::GetHatchProperties( const QString& MOName,
				bool&	       Unidirectional,
				bool&	       Bidirectional,
				bool&	       Meandering,
				bool&	       OnTheFly,
...
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,	  (void*)&MOName,	  (void*)&Unidirectional,
		       (void*)&Bidirectional,	  (void*)&Meandering,	  (void*)&OnTheFly,
		       (void*)&LineExcess,	  (void*)&NoOutline,	  (void*)&Inverse,
		       (void*)&OutlineCorrection, (void*)&AutoLineWitdth, (void*)&OptimizeJumps,
		       (void*)&HatchAngle,	  (void*)&FromOutline,	  (void*)&Overlap };
	qt_metacall( QMetaObject::InvokeMetaMethod, 36, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetIODefinitions( LMOSACTXLib::eIODirection eDir, const QVariant& bitfunction )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetLayerProperties( const QString& MOName, QString& LayerName )
{
	bool  qax_result;
...
inline QString
_DLMOSActX::GetLogo( const QString& ObjectName )
{
	QString qax_result;
...
inline bool
_DLMOSActX::GetLogoProperties( const QString& LogoName,
			       QString&	      FileName,
			       bool&	      OriginalSize,
			       double&	      xScale,
			       double&	      yScale,
...
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&LogoName, (void*)&FileName, (void*)&OriginalSize,
		       (void*)&xScale,	   (void*)&yScale,   (void*)&Slant,    (void*)&Hatch };
	qt_metacall( QMetaObject::InvokeMetaMethod, 42, _a );
	return qax_result;
}

inline QString
_DLMOSActX::GetMODescription( const QString& MOName )
{
	QString qax_result;
...
inline bool
_DLMOSActX::GetMOQPSet( const QString& MOName, QString& QPSetName, LMOSQPSetTypeConstants& QPSetType )
{
	bool  qax_result;
...
inline LMOSMOTypeConstants
_DLMOSActX::GetMOType( const QString& MOName )
{
...
inline QString
_DLMOSActX::GetMarkingFilesPath()
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result };
...
inline int
_DLMOSActX::GetMatrixCellAmount( const QString& MatrixName )
{
	int   qax_result;
...
inline bool
_DLMOSActX::GetMatrixCellProperties( const QString& MatrixName,
				     double&	    Width,
				     double&	    Height,
				     double&	    XOffset,
				     double&	    YOffset,
...
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&Width,  (void*)&Height,	   (void*)&XOffset,
		       (void*)&YOffset,	   (void*)&XShift,     (void*)&YShift, (void*)&Orientation };
	qt_metacall( QMetaObject::InvokeMetaMethod, 49, _a );
	return qax_result;
}

inline QString
_DLMOSActX::GetMatrixCustomType( const QString& MatrixName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&MatrixName };
...
inline bool
_DLMOSActX::GetMatrixGroupData(
	const QString& MatrixName, int Index, double& X, int& xElements, double& Y, int& yElements )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&Index,	 (void*)&X,
		       (void*)&xElements,  (void*)&Y,	       (void*)&yElements };
	qt_metacall( QMetaObject::InvokeMetaMethod, 51, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetMatrixGroupProperties( const QString& MatrixName, double& X, int& xElements, double& Y, int& yElements )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&X,
		       (void*)&xElements,  (void*)&Y,	       (void*)&yElements };
...
inline bool
_DLMOSActX::GetMatrixInterleaveProperties( const QString& MatrixName, double& X, double& Y )
{
	bool  qax_result;
...
inline int
_DLMOSActX::GetMatrixMaxBinCount( const QString& MatrixName )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName };
...
inline bool
_DLMOSActX::GetMatrixOptionProperties( const QString& MatrixName,
				       QString&	      CustomType,
				       bool&	      ColoredCell,
				       bool&	      ShowReferenceCell,
				       bool&	      BinLayoutStatic,
				       ...
				       bool&	      Multiplexed )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,	  (void*)&MatrixName,
		       (void*)&CustomType,	  (void*)&ColoredCell,
		       (void*)&ShowReferenceCell, (void*)&BinLayoutStatic,
		       (void*)&BinLayoutDynamic,  (void*)&maxBin,
		       (void*)&Multiplexed };
...
inline bool
_DLMOSActX::GetMatrixRowsAndColsCnt( const QString& MatrixName, int& RowCnt, int& ColCnt )
{
	bool  qax_result;
...
inline int
_DLMOSActX::GetMissingResources( QVariant& list )
{
	int   qax_result;
...
inline bool
_DLMOSActX::GetPosValues( const QString& ObjectName, double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetPosValuesAbs( const QString& ObjectName, int lMatrixCellIndex, double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&lMatrixCellIndex,
		       (void*)&dX,	   (void*)&dY,	       (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 60, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetQPSetProperties( const QString&			    QPSetName,
				LMOSACTXLib::LMOSQPSetTypeConstants QPSetType,
				const QString&			    MOName,
				QVariant&			    PropertyNames,
				QVariant&			    PropertyValues )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&QPSetName,	  (void*)&QPSetType,
		       (void*)&MOName,	   (void*)&PropertyNames, (void*)&PropertyValues };
	qt_metacall( QMetaObject::InvokeMetaMethod, 61, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetQualityParam( const QString&	     qpname,
			     LMOSACTXLib::eQPType    qptype,
			     LMOSACTXLib::eParamType partype,
			     QVariant&		     varVal )
{
...
inline int
_DLMOSActX::GetResources( QVariant& list )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&list };
...
inline bool
_DLMOSActX::GetRuntimeHeadOffset( double& X, double& Y, int hindex )
{
	bool  qax_result;
...
inline ShutterStateConstants
_DLMOSActX::GetShutterState()
{
...
inline bool
_DLMOSActX::GetSignal( LMOSACTXLib::eSignalConstants Signal )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetSizePosProperties( const QString&	MOName,
				  double&		PositionX,
				  double&		PositionY,
				  double&		SizeDX,
				  double&		SizeDY,
...
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,     (void*)&MOName,	     (void*)&PositionX, (void*)&PositionY,
		       (void*)&SizeDX,	       (void*)&SizeDY,	     (void*)&Angle,	(void*)&PreserveAspectRatio,
		       (void*)&FlipHorizontal, (void*)&FlipVertical, (void*)&RefPoint };
	qt_metacall( QMetaObject::InvokeMetaMethod, 67, _a );
	return qax_result;
}

inline bool
_DLMOSActX::GetSurfaceRadius( double& radius )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetSurfaceRefPoint( double& RefX, double& RefY, double& RefZ )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetSurfaceVector( double& VecX, double& VecY, double& VecZ )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::GetSystemParameter( LMOSACTXLib::eSystemParameterGet partype, QVariant& varVal )
{
	bool  qax_result;
...
inline QString
_DLMOSActX::GetText( const QString& ObjectName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&ObjectName };
...
inline bool
_DLMOSActX::ImportDXFFile( const QString& DXFFileName )
{
	bool  qax_result;
...
inline void
_DLMOSActX::ImportDXFFile2( const QString& DXFFileName )
{
...
inline bool
_DLMOSActX::ImportLogoFile( const QString& XMLFileName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::ImportLogoFile2( const QString& XMLFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLFileName };
...
inline bool
_DLMOSActX::ImportPSFile( const QString& PSFileName )
{
	bool  qax_result;
...
inline void
_DLMOSActX::ImportPSFile2( const QString& PSFileName )
{
...
inline bool
_DLMOSActX::ImportXMLFile( const QString& XMLFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLFileName };
...
inline void
_DLMOSActX::ImportXMLFile2( const QString& XMLFileName )
{
...
inline bool
_DLMOSActX::InitMachineEx( LMOSACTXLib::eMachineModuleConstants ModulesMask )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::IsFeatureLicensed( const QString& feature )
{
	bool  qax_result;
...
inline int
_DLMOSActX::IsMOName( const QString& MOName )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName };
...
inline IDispatch*
_DLMOSActX::Layer( const QString& Name )
{
...
inline bool
_DLMOSActX::LoadInclinedPlaneFCR( double dAlpha,
				  double dBeta,
				  double dBeamOrigin,
				  double dPlaneIntersectionOffset,
				  int	 lPlaneIntersectionOrientation,
				  int	 lHeadIndex )
{
	...
	void* _a[] = { (void*)&qax_result,
		       ...
		       (void*)&dBeta,
		       (void*)&dBeamOrigin,
		       (void*)&dPlaneIntersectionOffset,
		       (void*)&lPlaneIntersectionOrientation,
		       (void*)&lHeadIndex };
...
inline bool
_DLMOSActX::LoadXML( const QString& XMLString )
{
	bool  qax_result;
...
inline void
_DLMOSActX::LoadXML2( const QString& XMLString )
{
...
inline bool
_DLMOSActX::MatrixAssignBinLayout( const QString& MatrixName, int BinNum, const QString& LayoutName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::MatrixAssignBinText( const QString& MatrixName,
				 int		BinNum,
				 const QString& ObjectName,
				 const QString& BinText )
{
...
inline int
_DLMOSActX::MatrixQueryBin( const QString& MatrixName, int CellIndex )
{
	int   qax_result;
...
inline QString
_DLMOSActX::MatrixQueryBinText( const QString& MatrixName, int BinNum, const QString& ObjectName )
{
	QString qax_result;
...
inline bool
_DLMOSActX::MatrixQueryCellsPerPart( const QString& MatrixName, int PartIndex, int& CellStartIndex, int& CellCnt )
{
	bool  qax_result;
	void* _a[] = {
		(void*)&qax_result, (void*)&MatrixName, (void*)&PartIndex, (void*)&CellStartIndex, (void*)&CellCnt
	};
...
inline bool
_DLMOSActX::MatrixQueryPartCnt( const QString& MatrixName, int& PartCnt )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::MatrixSelectBin( const QString& MatrixName, int CellIndex, int BinNum )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::MatrixSelectBinAll( const QString& MatrixName, QVariant& BinValues )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::MoveA( const QString& ObjectName, double dX, double dY )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::PLCCommand( const QString& ID1, const QString& ID2, const QString& Command )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::PLCCommandEx( const QString& ID1, const QString& ID2, const QVariant& Command )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ID1, (void*)&ID2, (void*)&Command };
...
inline bool
_DLMOSActX::ReadByte( LMOSACTXLib::InPortConstants Port, int bMask, int& InByte )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::ReadIOBit( const QVariant& bitfunction, QVariant& Result )
{
	bool  qax_result;
...
inline void
_DLMOSActX::RemoveGlobalQPSet( const QString& Name )
{
	void* _a[] = { 0, (void*)&Name };
...
inline void
_DLMOSActX::RemoveLocalQPSet( const QString& Name )
{
	void* _a[] = { 0, (void*)&Name };
...
inline bool
_DLMOSActX::ReplaceDrawing( const QString& FileName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::ReplaceGlobalQPSet( const QString& OriginalQPSetName, const QString& NewQPSetName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::ReplaceLocalQPSet( const QString& OriginalQPSetName, const QString& NewQPSetName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&OriginalQPSetName, (void*)&NewQPSetName };
...
inline bool
_DLMOSActX::RotateA( const QString& ObjectName, double dAngle )
{
	bool  qax_result;
...
inline void
_DLMOSActX::RotateView( double Angle )
{
...
inline bool
_DLMOSActX::Save( const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FileName };
...
inline bool
_DLMOSActX::SaveAsVersion( const QString& FileName, LMOSACTXLib::LMOSSaveAsVersionConstants SaveVersion )
{
	bool  qax_result;
...
inline void
_DLMOSActX::SaveGlobalHatchSets()
{
	void* _a[] = { 0 };
...
inline bool
_DLMOSActX::SaveImage( int resx, int resy, const QString& FileName )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SaveImageWithRuler( int resx, int resy, const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&resx, (void*)&resy, (void*)&FileName };
...
inline bool
_DLMOSActX::SelectShadow( int ShadowIndex )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SelectSingleStep( int StepIndex )
{
	bool  qax_result;
...
inline void
_DLMOSActX::SetAxisUsedInVLM( LMOSACTXLib::eAxisType eAxis, bool Value )
{
...
inline bool
_DLMOSActX::SetDimension( const QString& ObjectName, double dWidth, double dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dWidth, (void*)&dHeight };
...
inline bool
_DLMOSActX::SetGlobalQPSet( const QString& QPSetName, double CURRENT, int SPEED, int FREQUENCY, bool bSave )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&QPSetName, (void*)&CURRENT,
		       (void*)&SPEED,	   (void*)&FREQUENCY, (void*)&bSave };
	qt_metacall( QMetaObject::InvokeMetaMethod, 127, _a );
	return qax_result;
}

inline bool
_DLMOSActX::SetHatchParam( const QString&		hpname,
			   LMOSACTXLib::eHSType		hstype,
			   LMOSACTXLib::eHatchParamType partype,
			   const QVariant&		varVal )
{
...
inline bool
_DLMOSActX::SetHatchProperties( const QString& MOName,
				bool	       Unidirectional,
				bool	       Bidirectional,
				bool	       Meandering,
				bool	       OnTheFly,
				...
				double	       Overlap )
{
	...
	void* _a[] = { (void*)&qax_result,	  (void*)&MOName,	 (void*)&Unidirectional,
		       (void*)&Bidirectional,	  (void*)&Meandering,	 (void*)&OnTheFly,
		       (void*)&LineExcess,	  (void*)&NoOutline,	 (void*)&Inverse,
		       (void*)&OutlineCorrection, (void*)&AutoLineWidth, (void*)&OptimizeJumps,
		       (void*)&HatchAngle,	  (void*)&FromOutline,	 (void*)&Overlap };
...
inline bool
_DLMOSActX::SetLaserable( const QString& MOName, bool bFlag )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetLogo( const QString& ObjectName, const QString& VariableValue )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMODescription( const QString& MOName, const QString& description )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMOLayer( const QString& MOName, const QString& LayerName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&LayerName };
...
inline bool
_DLMOSActX::SetMatrixCellAngle( const QString& MatrixName, double dAngle )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMatrixCellOccupation( const QString& MatrixName, int iCellIndex, bool IsOccupied )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMatrixCellOccupationAll( const QString& MatrixName, QVariant& OccValues )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMatrixCellOffset( const QString& MatrixName, int iCellIndex, double OffX, double OffY, double OffPhi )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&iCellIndex,
		       (void*)&OffX,	   (void*)&OffY,       (void*)&OffPhi };
	qt_metacall( QMetaObject::InvokeMetaMethod, 138, _a );
	return qax_result;
}

inline bool
_DLMOSActX::SetMatrixMaxBinCount( const QString& MatrixName, int MaxBinCount )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetMatrixRefCell( const QString& MatrixName, int iIndex, bool bDrawRefCellOnly )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::SetPosValues( const QString& ObjectName, double dX, double dY, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dX, (void*)&dY, (void*)&dAngle };
...
inline bool
_DLMOSActX::SetQualityParam( const QString&	     qpname,
			     LMOSACTXLib::eQPType    qptype,
			     LMOSACTXLib::eParamType partype,
			     const QVariant&	     varVal,
			     bool		     bSave )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&qpname, (void*)&qptype,
		       (void*)&partype,	   (void*)&varVal, (void*)&bSave };
	qt_metacall( QMetaObject::InvokeMetaMethod, 142, _a );
	return qax_result;
}

inline bool
_DLMOSActX::SetRuntimeHeadOffset( double X, double Y, int hindex )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&X, (void*)&Y, (void*)&hindex };
...
inline void
_DLMOSActX::SetSignal( LMOSACTXLib::eSignalConstants Signal, bool Value )
{
...
inline bool
_DLMOSActX::SetSurfaceRadius( double radius )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&radius };
...
inline bool
_DLMOSActX::SetSurfaceRefPoint( double RefX, double RefY, double RefZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&RefX, (void*)&RefY, (void*)&RefZ };
...
inline bool
_DLMOSActX::SetSurfaceVector( double VecX, double VecY, double VecZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&VecX, (void*)&VecY, (void*)&VecZ };
...
inline bool
_DLMOSActX::SetSystemParameter( LMOSACTXLib::eSystemParameterSet partype, const QVariant& varVal )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&partype, (void*)&varVal };
...
inline bool
_DLMOSActX::SetText( const QString& ObjectName, const QString& VariableValue )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&VariableValue };
...
inline void
_DLMOSActX::ShowMarkingAreaZoom()
{
	void* _a[] = { 0 };
...
inline void
_DLMOSActX::ShowMatrixCell2( const QString& MatrixName )
{
...
inline bool
_DLMOSActX::ShowZoomWindow( int topLeftX, int topLeftY, int bottomRightX, int bottomRightY )
{
	bool  qax_result;
	void* _a[] = {
		(void*)&qax_result, (void*)&topLeftX, (void*)&topLeftY, (void*)&bottomRightX, (void*)&bottomRightY
	};
...
inline bool
_DLMOSActX::SplitDrawing( double offset, double Overlap )
{
	bool  qax_result;
...
inline void
_DLMOSActX::StartPosHelp( const QString& ObjectName )
{
...
inline void
_DLMOSActX::StartPosHelpLast( const QString& ObjectName )
{
	void* _a[] = { 0, (void*)&ObjectName };
...
inline bool
_DLMOSActX::TTLFieldCorr( const QString& FileName, int Action, int Head )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::TTLPxCamera( double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY };
...
inline bool
_DLMOSActX::TTLPxLaser( double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY };
...
inline bool
_DLMOSActX::TermMachineEx( LMOSACTXLib::eMachineModuleConstants ModulesMask )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ModulesMask };
...
inline IDispatch*
_DLMOSActX::TextObjects( const QString& MOName )
{
	IDispatch* qax_result = 0;
	void*	   _a[]	      = { (void*)&qax_result, (void*)&MOName };
...
inline bool
_DLMOSActX::WaitOnByte( LMOSACTXLib::InPortConstants Port, int bMask, int bData, int lTimeOut )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::WaitOnIOBit( const QVariant& bitfunction, const QVariant& values, int timeout )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::WriteByte( LMOSACTXLib::OutPortConstants Port, int bMask, int bData )
{
	bool  qax_result;
...
inline bool
_DLMOSActX::WriteIOBit( const QVariant& bitfunction, const QVariant& values )
{
	bool  qax_result;
...
inline LMOSACTXLib::eResourceTypes
IResDesc::ResType() const
{
...
inline bool
IAxis::AxisAvailable( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 8, _a );
...
inline QVariant
IAxis::GetAxisParameter( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eAxisParamType eAxisParam )
{
	QVariant qax_result;
...
inline double
IAxis::GetPos( LMOSACTXLib::eAxisType eAxis )
{
	double qax_result;
	void*  _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 10, _a );
...
inline double
IAxis::GetPos( LMOSACTXLib::eAxisType eAxis, bool bDoRequest )
{
	double qax_result;
...
inline bool
IAxis::Inverted( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 16, _a );
...
inline void
IAxis::Jog( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eJogType eJog )
{
...
inline void
IAxis::MoveAxisAsync( LMOSACTXLib::eAxisType eAxis, double dPos, bool bIsAbsoultePos )
{
...
inline void
IAxis::NewPos( LMOSACTXLib::eAxisType eAxis, double dPos, bool bIsAbsoultePos )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&dPos, (void*)&bIsAbsoultePos };
	qt_metacall( QMetaObject::InvokeMetaMethod, 22, _a );
}
...
inline void
IAxis::NewReference( LMOSACTXLib::eAxisType eAxis )
{
...
inline void
IAxis::SetAxisParameter( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eAxisParamType eAxisParam, const QVariant& val )
{
...
inline void
IAxis::SetInverted( LMOSACTXLib::eAxisType eAxis, bool rhs )
{
...
inline void
IAxis::StopAxis( LMOSACTXLib::eAxisType eAxis )
{
	void* _a[] = { 0, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 28, _a );
}
...
inline QVariant
IMachineCfg::GetValue( int categoryId, int valueId )
{
	QVariant qax_result;
...
inline void
IMachineCfg::SetValue( int categoryId, int valueId, const QVariant& Value )
{
...
inline void
Layer::SetExportable( bool value )
{
	setProperty( "Exportable", QVariant( value ) );
}

inline double
Layer::FocusCorrection() const
{
	QVariant qax_result = property( "FocusCorrection" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
Layer::SetFocusCorrection( double value )
{
	setProperty( "FocusCorrection", QVariant( value ) );
}

inline double
Layer::HeightZAxis() const
{
	QVariant qax_result = property( "HeightZAxis" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
Layer::SetHeightZAxis( double value )
{
	setProperty( "HeightZAxis", QVariant( value ) );
}

inline bool
Layer::Laserable() const
{
	QVariant qax_result = property( "Laserable" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
Layer::SetSelectable( bool value )
{
	setProperty( "Selectable", QVariant( value ) );
}
...
inline LMOSACTXLib::ILayer*
Layers::Item( const QString& Name )
{
	LMOSACTXLib::ILayer* qax_result = 0;
	qRegisterMetaType<LMOSACTXLib::ILayer*>( "ILayer*", &qax_result );
	qRegisterMetaType<LMOSACTXLib::ILayer>( "ILayer", qax_result );
...
inline bool
Axis::AxisAvailable( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 13, _a );
...
inline QVariant
Axis::GetAxisParameter( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eAxisParamType eAxisParam )
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result, (void*)&eAxis, (void*)&eAxisParam };
	qt_metacall( QMetaObject::InvokeMetaMethod, 14, _a );
...
inline double
Axis::GetPos( LMOSACTXLib::eAxisType eAxis )
{
	double qax_result;
	void*  _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 15, _a );
...
inline double
Axis::GetPos( LMOSACTXLib::eAxisType eAxis, bool bDoRequest )
{
	double qax_result;
	void*  _a[] = { (void*)&qax_result, (void*)&eAxis, (void*)&bDoRequest };
	qt_metacall( QMetaObject::InvokeMetaMethod, 16, _a );
...
inline bool
Axis::Inverted( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 21, _a );
...
inline void
Axis::Jog( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eJogType eJog )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&eJog };
	qt_metacall( QMetaObject::InvokeMetaMethod, 22, _a );
}
...
inline void
Axis::MoveAxisAsync( LMOSACTXLib::eAxisType eAxis, double dPos, bool bIsAbsoultePos )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&dPos, (void*)&bIsAbsoultePos };
	qt_metacall( QMetaObject::InvokeMetaMethod, 24, _a );
}
...
inline void
Axis::NewPos( LMOSACTXLib::eAxisType eAxis, double dPos, bool bIsAbsoultePos )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&dPos, (void*)&bIsAbsoultePos };
	qt_metacall( QMetaObject::InvokeMetaMethod, 27, _a );
}
...
inline void
Axis::NewReference( LMOSACTXLib::eAxisType eAxis )
{
	void* _a[] = { 0, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 28, _a );
}
...
inline void
Axis::SetAxisParameter( LMOSACTXLib::eAxisType eAxis, LMOSACTXLib::eAxisParamType eAxisParam, const QVariant& val )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&eAxisParam, (void*)&val };
	qt_metacall( QMetaObject::InvokeMetaMethod, 30, _a );
}
...
inline void
Axis::SetInverted( LMOSACTXLib::eAxisType eAxis, bool rhs )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&rhs };
	qt_metacall( QMetaObject::InvokeMetaMethod, 31, _a );
}
...
inline void
Axis::StopAxis( LMOSACTXLib::eAxisType eAxis )
{
	void* _a[] = { 0, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 33, _a );
}
...
inline void
Variable::SetValue( const QString& value )
{
	setProperty( "Value", QVariant( value ) );
}

inline QString
Variable::_Value() const
{
...
inline void
Variable::set_Value( const QString& value )
{
	setProperty( "_Value", QVariant( value ) );
}


inline int
IVariable::Length() const
{
	QVariant qax_result = property( "Length" );
	Q_ASSERT( qax_result.isValid() );
	return *(int*)qax_result.constData();
...
inline void
IVariable::SetValue( const QString& value )
{
	setProperty( "Value", QVariant( value ) );
}

inline QString
IVariable::_Value() const
{
	QVariant qax_result = property( "_Value" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
IVariable::set_Value( const QString& value )
{
	setProperty( "_Value", QVariant( value ) );
}
...
inline LMOSACTXLib::IVariable*
Variables::Item( const QString& Name )
{
...
inline LMOSACTXLib::IVariable*
IVariables::Item( const QString& Name )
{
	LMOSACTXLib::IVariable* qax_result = 0;
	qRegisterMetaType<LMOSACTXLib::IVariable*>( "IVariable*", &qax_result );
	qRegisterMetaType<LMOSACTXLib::IVariable>( "IVariable", qax_result );
...
inline void
TextObject::SetAlignment( int value )
{
	setProperty( "Alignment", QVariant( value ) );
}

inline double
TextObject::CharSpace() const
{
...
inline void
TextObject::SetCharSpace( double value )
{
	setProperty( "CharSpace", QVariant( value ) );
}

inline QString
TextObject::Font() const
{
...
inline void
TextObject::SetFont( const QString& value )
{
	setProperty( "Font", QVariant( value ) );
}

inline int
TextObject::FrameMode() const
{
...
inline void
TextObject::SetFrameMode( int value )
{
	setProperty( "FrameMode", QVariant( value ) );
}

inline double
TextObject::Height() const
{
...
inline void
TextObject::SetHeight( double value )
{
	setProperty( "Height", QVariant( value ) );
}
...
inline void
TextObject::SetIsCrossfree( bool value )
{
	setProperty( "IsCrossfree", QVariant( value ) );
}

inline bool
TextObject::IsFixedSize() const
{
...
inline void
TextObject::SetIsFixedSize( bool value )
{
	setProperty( "IsFixedSize", QVariant( value ) );
}

inline bool
TextObject::IsHatched() const
{
...
inline void
TextObject::SetIsHatched( bool value )
{
	setProperty( "IsHatched", QVariant( value ) );
}

inline double
TextObject::Italic() const
{
...
inline void
TextObject::SetItalic( double value )
{
	setProperty( "Italic", QVariant( value ) );
}

inline double
TextObject::LineSpace() const
{
...
inline void
TextObject::SetLineSpace( double value )
{
	setProperty( "LineSpace", QVariant( value ) );
}

inline QString
TextObject::Name() const
{
	QVariant qax_result = property( "Name" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
TextObject::SetRatio( double value )
{
	setProperty( "Ratio", QVariant( value ) );
}

inline QString
TextObject::Text() const
{
...
inline void
TextObject::SetText( const QString& value )
{
	setProperty( "Text", QVariant( value ) );
}


inline int
ITextObject::Alignment() const
{
	QVariant qax_result = property( "Alignment" );
	Q_ASSERT( qax_result.isValid() );
	return *(int*)qax_result.constData();
...
inline void
ITextObject::SetAlignment( int value )
{
	setProperty( "Alignment", QVariant( value ) );
}

inline double
ITextObject::CharSpace() const
{
	QVariant qax_result = property( "CharSpace" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
ITextObject::SetCharSpace( double value )
{
	setProperty( "CharSpace", QVariant( value ) );
}

inline QString
ITextObject::Font() const
{
	QVariant qax_result = property( "Font" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
ITextObject::SetFont( const QString& value )
{
	setProperty( "Font", QVariant( value ) );
}

inline int
ITextObject::FrameMode() const
{
	QVariant qax_result = property( "FrameMode" );
	Q_ASSERT( qax_result.isValid() );
	return *(int*)qax_result.constData();
...
inline void
ITextObject::SetFrameMode( int value )
{
	setProperty( "FrameMode", QVariant( value ) );
}

inline double
ITextObject::Height() const
{
	QVariant qax_result = property( "Height" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
ITextObject::SetHeight( double value )
{
	setProperty( "Height", QVariant( value ) );
}

inline int
ITextObject::ID() const
{
	QVariant qax_result = property( "ID" );
	Q_ASSERT( qax_result.isValid() );
	return *(int*)qax_result.constData();
...
inline void
ITextObject::SetIsCrossfree( bool value )
{
	setProperty( "IsCrossfree", QVariant( value ) );
}

inline bool
ITextObject::IsFixedSize() const
{
	QVariant qax_result = property( "IsFixedSize" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
ITextObject::SetIsFixedSize( bool value )
{
	setProperty( "IsFixedSize", QVariant( value ) );
}

inline bool
ITextObject::IsHatched() const
{
	QVariant qax_result = property( "IsHatched" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
ITextObject::SetIsHatched( bool value )
{
	setProperty( "IsHatched", QVariant( value ) );
}

inline double
ITextObject::Italic() const
{
	QVariant qax_result = property( "Italic" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
ITextObject::SetItalic( double value )
{
	setProperty( "Italic", QVariant( value ) );
}

inline double
ITextObject::LineSpace() const
{
	QVariant qax_result = property( "LineSpace" );
	Q_ASSERT( qax_result.isValid() );
	return *(double*)qax_result.constData();
...
inline void
ITextObject::SetLineSpace( double value )
{
	setProperty( "LineSpace", QVariant( value ) );
}

inline QString
ITextObject::Name() const
{
	QVariant qax_result = property( "Name" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
ITextObject::SetRatio( double value )
{
	setProperty( "Ratio", QVariant( value ) );
}

inline QString
ITextObject::Text() const
{
	QVariant qax_result = property( "Text" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
ITextObject::SetText( const QString& value )
{
	setProperty( "Text", QVariant( value ) );
}
...
inline LMOSACTXLib::ITextObject*
TextObjects::Item( int ID )
{
...
inline QString
ComponentBase::GenericName() const
{
...
inline QVariant
ComponentBase::GetAttribute( const QString& attributeName, bool sync )
{
	QVariant qax_result;
...
inline void
ComponentBase::SetAttribute( const QString& attributeName, const QVariant& val, bool sync )
{
...
inline QString
IComponentBase::ClassInfo() const
{
	QVariant qax_result = property( "ClassInfo" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline QString
IComponentBase::ClassName() const
{
	QVariant qax_result = property( "ClassName" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline QString
IComponentBase::GenericName() const
{
	QVariant qax_result = property( "GenericName" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline QVariant
IComponentBase::GetAttribute( const QString& attributeName, bool sync )
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result, (void*)&attributeName, (void*)&sync };
	qt_metacall( QMetaObject::InvokeMetaMethod, 8, _a );
...
inline void
IComponentBase::SetAttribute( const QString& attributeName, const QVariant& val, bool sync )
{
	void* _a[] = { 0, (void*)&attributeName, (void*)&val, (void*)&sync };
	qt_metacall( QMetaObject::InvokeMetaMethod, 9, _a );
}
...
inline LMOSACTXLib::IComponentBase*
ComponentBases::Item( int ID )
{
...
inline QString
MachineCfgParam::Category() const
{
...
inline QString
IMachineCfgParam::Category() const
{
	QVariant qax_result = property( "Category" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline LMOSACTXLib::IMachineCfgParam*
MachineCfgParams::Item( int ID )
{
...
inline QString
PowerDialog::FailedReason() const
{
	QVariant qax_result = property( "FailedReason" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline int
PowerDialog::GetError( QString& description )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&description };
	qt_metacall( QMetaObject::InvokeMetaMethod, 9, _a );
...
inline bool
PowerDialog::HandleEvent( int lEvent )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&lEvent };
	qt_metacall( QMetaObject::InvokeMetaMethod, 10, _a );
...
inline IDispatch*
LMOSActX::AllMachineCfgParams() const
{
	QVariant qax_result = property( "AllMachineCfgParams" );
	if ( !qax_result.constData() ) {
		return 0;
...
inline bool
LMOSActX::AutoSignalJobEnd() const
{
	QVariant qax_result = property( "AutoSignalJobEnd" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
LMOSActX::SetAutoSignalJobEnd( bool value )
{
	setProperty( "AutoSignalJobEnd", QVariant( value ) );
}

inline bool
LMOSActX::AutoSignalMarkingEnd() const
{
	QVariant qax_result = property( "AutoSignalMarkingEnd" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
LMOSActX::SetAutoSignalMarkingEnd( bool value )
{
	setProperty( "AutoSignalMarkingEnd", QVariant( value ) );
}
...
inline void
LMOSActX::SetDummy1( int value )
{
	setProperty( "Dummy1", QVariant( value ) );
}

inline int
LMOSActX::Dummy2() const
{
	QVariant qax_result = property( "Dummy2" );
	Q_ASSERT( qax_result.isValid() );
	return *(int*)qax_result.constData();
...
inline void
LMOSActX::SetDummy2( int value )
{
	setProperty( "Dummy2", QVariant( value ) );
}

inline QString
LMOSActX::FileName() const
{
	QVariant qax_result = property( "FileName" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
LMOSActX::SetFileName( const QString& value )
{
	setProperty( "FileName", QVariant( value ) );
}

inline IDispatch*
LMOSActX::GlobalVariables() const
{
	QVariant qax_result = property( "GlobalVariables" );
	if ( !qax_result.constData() ) {
		return 0;
...
inline void
LMOSActX::SetHasMatrix( bool value )
{
	setProperty( "HasMatrix", QVariant( value ) );
}

inline IDispatch*
LMOSActX::Layers() const
{
	QVariant qax_result = property( "Layers" );
	if ( !qax_result.constData() ) {
		return 0;
...
inline bool
LMOSActX::SuppressAutoRedraw() const
{
	QVariant qax_result = property( "SuppressAutoRedraw" );
	Q_ASSERT( qax_result.isValid() );
	return *(bool*)qax_result.constData();
...
inline void
LMOSActX::SetSuppressAutoRedraw( bool value )
{
	setProperty( "SuppressAutoRedraw", QVariant( value ) );
}

inline QString
LMOSActX::VLMBuildLevel() const
{
	QVariant qax_result = property( "VLMBuildLevel" );
	Q_ASSERT( qax_result.isValid() );
	return *(QString*)qax_result.constData();
...
inline void
LMOSActX::ActivateZoomWindow( bool newState )
{
	void* _a[] = { 0, (void*)&newState };
	qt_metacall( QMetaObject::InvokeMetaMethod, 67, _a );
}
...
inline void
LMOSActX::AddGlobalQPSet( const QString& Name, double CURRENT, int SPEED, int FREQUENCY )
{
	void* _a[] = { 0, (void*)&Name, (void*)&CURRENT, (void*)&SPEED, (void*)&FREQUENCY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 68, _a );
}
...
inline void
LMOSActX::AddLocalQPSet( const QString& Name, double CURRENT, int SPEED, int FREQUENCY )
{
	void* _a[] = { 0, (void*)&Name, (void*)&CURRENT, (void*)&SPEED, (void*)&FREQUENCY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 69, _a );
}
...
inline bool
LMOSActX::DrawingAngleOffset( double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 74, _a );
...
inline bool
LMOSActX::DrawingGetDimension( double& dWidth, double& dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dWidth, (void*)&dHeight };
	qt_metacall( QMetaObject::InvokeMetaMethod, 75, _a );
...
inline bool
LMOSActX::DrawingGetPosValues( double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY, (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 76, _a );
...
inline bool
LMOSActX::DrawingPosOffset( double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 77, _a );
...
inline bool
LMOSActX::DrawingSetDimension( double dWidth, double dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dWidth, (void*)&dHeight };
	qt_metacall( QMetaObject::InvokeMetaMethod, 78, _a );
...
inline bool
LMOSActX::DrawingSetPosValues( double dX, double dY, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY, (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 79, _a );
...
inline void
LMOSActX::DriftCorr( double lambda1, double lambda2, double deltax, double deltay, int hindex )
{
	void* _a[] = { 0, (void*)&lambda1, (void*)&lambda2, (void*)&deltax, (void*)&deltay, (void*)&hindex };
	qt_metacall( QMetaObject::InvokeMetaMethod, 80, _a );
}
...
inline void
LMOSActX::DriftCorrInternal( LMOSACTXLib::eHeads Head, LMOSACTXLib::eDriftModes mode )
{
	void* _a[] = { 0, (void*)&Head, (void*)&mode };
	qt_metacall( QMetaObject::InvokeMetaMethod, 81, _a );
}
...
inline bool
LMOSActX::ExportAsLogo( const QString& LogoName, bool ExportEllipsesAsPolylines, int IncrementsPerFullEllipse )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result,
		       (void*)&LogoName,
...
inline bool
LMOSActX::ExportPl0( const QString& PL0FileName, bool bShowInitDlg )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&PL0FileName, (void*)&bShowInitDlg };
	qt_metacall( QMetaObject::InvokeMetaMethod, 83, _a );
...
inline bool
LMOSActX::ExportVISFile( const QString& VISFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&VISFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 84, _a );
...
inline bool
LMOSActX::FileName2( const QString& FName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 85, _a );
...
inline bool
LMOSActX::GetAxisUsedInVLM( LMOSACTXLib::eAxisType eAxis )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eAxis };
	qt_metacall( QMetaObject::InvokeMetaMethod, 87, _a );
...
inline bool
LMOSActX::GetBackgroundProperties( const QString& MOName,
				   bool&	  ShowFrame,
				   bool&	  DrawFrame,
				   bool&	  BackgroundBitmap,
				   QString&	  BitmapName,
...
inline bool
LMOSActX::GetDimension( const QString& ObjectName, double& dWidth, double& dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dWidth, (void*)&dHeight };
	qt_metacall( QMetaObject::InvokeMetaMethod, 89, _a );
...
inline QVariant
LMOSActX::GetGlobalHatchSetNames()
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result };
	qt_metacall( QMetaObject::InvokeMetaMethod, 90, _a );
...
inline bool
LMOSActX::GetGlobalQPSet( const QString& QPSetName, double& CURRENT, int& SPEED, int& FREQUENCY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&QPSetName, (void*)&CURRENT, (void*)&SPEED, (void*)&FREQUENCY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 91, _a );
...
inline bool
LMOSActX::GetHatchParam( const QString&		      hpname,
			 LMOSACTXLib::eHSType	      hstype,
			 LMOSACTXLib::eHatchParamType partype,
			 QVariant&		      varVal )
{
...
inline bool
LMOSActX::GetHatchProperties( const QString& MOName,
			      bool&	     Unidirectional,
			      bool&	     Bidirectional,
			      bool&	     Meandering,
			      bool&	     OnTheFly,
...
inline bool
LMOSActX::GetIODefinitions( LMOSACTXLib::eIODirection eDir, const QVariant& bitfunction )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&eDir, (void*)&bitfunction };
	qt_metacall( QMetaObject::InvokeMetaMethod, 95, _a );
...
inline bool
LMOSActX::GetLayerProperties( const QString& MOName, QString& LayerName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&LayerName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 96, _a );
...
inline QString
LMOSActX::GetLogo( const QString& ObjectName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&ObjectName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 98, _a );
...
inline bool
LMOSActX::GetLogoProperties( const QString& LogoName,
			     QString&	    FileName,
			     bool&	    OriginalSize,
			     double&	    xScale,
			     double&	    yScale,
...
inline QString
LMOSActX::GetMODescription( const QString& MOName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&MOName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 101, _a );
...
inline bool
LMOSActX::GetMOQPSet( const QString& MOName, QString& QPSetName, LMOSQPSetTypeConstants& QPSetType )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&QPSetName, (void*)&QPSetType };
	qt_metacall( QMetaObject::InvokeMetaMethod, 103, _a );
...
inline LMOSMOTypeConstants
LMOSActX::GetMOType( const QString& MOName )
{
	LMOSMOTypeConstants qax_result;
	void*		    _a[] = { (void*)&qax_result, (void*)&MOName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 104, _a );
...
inline int
LMOSActX::GetMatrixCellAmount( const QString& MatrixName )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 106, _a );
...
inline bool
LMOSActX::GetMatrixCellProperties( const QString& MatrixName,
				   double&	  Width,
				   double&	  Height,
				   double&	  XOffset,
				   double&	  YOffset,
...
inline QString
LMOSActX::GetMatrixCustomType( const QString& MatrixName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&MatrixName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 108, _a );
...
inline bool
LMOSActX::GetMatrixGroupProperties( const QString& MatrixName, double& X, int& xElements, double& Y, int& yElements )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&X,
		       (void*)&xElements,  (void*)&Y,	       (void*)&yElements };
...
inline bool
LMOSActX::GetMatrixInterleaveProperties( const QString& MatrixName, double& X, double& Y )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&X, (void*)&Y };
	qt_metacall( QMetaObject::InvokeMetaMethod, 111, _a );
...
inline int
LMOSActX::GetMatrixMaxBinCount( const QString& MatrixName )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 112, _a );
...
inline bool
LMOSActX::GetMatrixOptionProperties( const QString& MatrixName,
				     QString&	    CustomType,
				     bool&	    ColoredCell,
				     bool&	    ShowReferenceCell,
				     bool&	    BinLayoutStatic,
...
inline bool
LMOSActX::GetMatrixRowsAndColsCnt( const QString& MatrixName, int& RowCnt, int& ColCnt )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&RowCnt, (void*)&ColCnt };
	qt_metacall( QMetaObject::InvokeMetaMethod, 114, _a );
...
inline int
LMOSActX::GetMissingResources( QVariant& list )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&list };
	qt_metacall( QMetaObject::InvokeMetaMethod, 115, _a );
...
inline bool
LMOSActX::GetPosValues( const QString& ObjectName, double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dX, (void*)&dY, (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 117, _a );
...
inline bool
LMOSActX::GetPosValuesAbs( const QString& ObjectName, int lMatrixCellIndex, double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&lMatrixCellIndex,
		       (void*)&dX,	   (void*)&dY,	       (void*)&dAngle };
...
inline bool
LMOSActX::GetQPSetProperties( const QString&			  QPSetName,
			      LMOSACTXLib::LMOSQPSetTypeConstants QPSetType,
			      const QString&			  MOName,
			      QVariant&				  PropertyNames,
			      QVariant&				  PropertyValues )
...
inline bool
LMOSActX::GetQualityParam( const QString&	   qpname,
			   LMOSACTXLib::eQPType	   qptype,
			   LMOSACTXLib::eParamType partype,
			   QVariant&		   varVal )
{
...
inline int
LMOSActX::GetResources( QVariant& list )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&list };
...
inline bool
LMOSActX::GetRuntimeHeadOffset( double& X, double& Y, int hindex )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&X, (void*)&Y, (void*)&hindex };
	qt_metacall( QMetaObject::InvokeMetaMethod, 122, _a );
...
inline bool
LMOSActX::GetSignal( LMOSACTXLib::eSignalConstants Signal )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&Signal };
...
inline bool
LMOSActX::GetSizePosProperties( const QString&	      MOName,
				double&		      PositionX,
				double&		      PositionY,
				double&		      SizeDX,
				double&		      SizeDY,
...
inline bool
LMOSActX::GetSurfaceRadius( double& radius )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&radius };
...
inline bool
LMOSActX::GetSurfaceRefPoint( double& RefX, double& RefY, double& RefZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&RefX, (void*)&RefY, (void*)&RefZ };
	qt_metacall( QMetaObject::InvokeMetaMethod, 127, _a );
...
inline bool
LMOSActX::GetSurfaceVector( double& VecX, double& VecY, double& VecZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&VecX, (void*)&VecY, (void*)&VecZ };
...
inline bool
LMOSActX::GetSystemParameter( LMOSACTXLib::eSystemParameterGet partype, QVariant& varVal )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&partype, (void*)&varVal };
	qt_metacall( QMetaObject::InvokeMetaMethod, 129, _a );
...
inline QString
LMOSActX::GetText( const QString& ObjectName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&ObjectName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 130, _a );
...
inline bool
LMOSActX::ImportDXFFile( const QString& DXFFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&DXFFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 131, _a );
...
inline void
LMOSActX::ImportDXFFile2( const QString& DXFFileName )
{
	void* _a[] = { 0, (void*)&DXFFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 132, _a );
}
...
inline bool
LMOSActX::ImportLogoFile( const QString& XMLFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 133, _a );
...
inline bool
LMOSActX::ImportLogoFile2( const QString& XMLFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 134, _a );
...
inline bool
LMOSActX::ImportPSFile( const QString& PSFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&PSFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 135, _a );
...
inline void
LMOSActX::ImportPSFile2( const QString& PSFileName )
{
	void* _a[] = { 0, (void*)&PSFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 136, _a );
}
...
inline bool
LMOSActX::ImportXMLFile( const QString& XMLFileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 137, _a );
...
inline void
LMOSActX::ImportXMLFile2( const QString& XMLFileName )
{
	void* _a[] = { 0, (void*)&XMLFileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 138, _a );
}
...
inline bool
LMOSActX::InitMachineEx( LMOSACTXLib::eMachineModuleConstants ModulesMask )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ModulesMask };
	qt_metacall( QMetaObject::InvokeMetaMethod, 140, _a );
...
inline bool
LMOSActX::IsFeatureLicensed( const QString& feature )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&feature };
	qt_metacall( QMetaObject::InvokeMetaMethod, 141, _a );
...
inline int
LMOSActX::IsMOName( const QString& MOName )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 142, _a );
...
inline IDispatch*
LMOSActX::Layer( const QString& Name )
{
	IDispatch* qax_result = 0;
	void*	   _a[]	      = { (void*)&qax_result, (void*)&Name };
	qt_metacall( QMetaObject::InvokeMetaMethod, 144, _a );
...
inline bool
LMOSActX::LoadInclinedPlaneFCR( double dAlpha,
				double dBeta,
				double dBeamOrigin,
				double dPlaneIntersectionOffset,
				int    lPlaneIntersectionOrientation,
...
inline bool
LMOSActX::LoadXML( const QString& XMLString )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&XMLString };
	qt_metacall( QMetaObject::InvokeMetaMethod, 147, _a );
...
inline void
LMOSActX::LoadXML2( const QString& XMLString )
{
	void* _a[] = { 0, (void*)&XMLString };
	qt_metacall( QMetaObject::InvokeMetaMethod, 148, _a );
}
...
inline bool
LMOSActX::MatrixAssignBinLayout( const QString& MatrixName, int BinNum, const QString& LayoutName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&BinNum, (void*)&LayoutName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 149, _a );
...
inline bool
LMOSActX::MatrixAssignBinText( const QString& MatrixName,
			       int	      BinNum,
			       const QString& ObjectName,
			       const QString& BinText )
{
...
inline int
LMOSActX::MatrixQueryBin( const QString& MatrixName, int CellIndex )
{
	int   qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&CellIndex };
	qt_metacall( QMetaObject::InvokeMetaMethod, 151, _a );
...
inline QString
LMOSActX::MatrixQueryBinText( const QString& MatrixName, int BinNum, const QString& ObjectName )
{
	QString qax_result;
	void*	_a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&BinNum, (void*)&ObjectName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 152, _a );
...
inline bool
LMOSActX::MatrixQueryCellsPerPart( const QString& MatrixName, int PartIndex, int& CellStartIndex, int& CellCnt )
{
	bool  qax_result;
	void* _a[] = {
		(void*)&qax_result, (void*)&MatrixName, (void*)&PartIndex, (void*)&CellStartIndex, (void*)&CellCnt
...
inline bool
LMOSActX::MatrixQueryPartCnt( const QString& MatrixName, int& PartCnt )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&PartCnt };
	qt_metacall( QMetaObject::InvokeMetaMethod, 154, _a );
...
inline bool
LMOSActX::MatrixSelectBin( const QString& MatrixName, int CellIndex, int BinNum )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&CellIndex, (void*)&BinNum };
	qt_metacall( QMetaObject::InvokeMetaMethod, 155, _a );
...
inline bool
LMOSActX::MatrixSelectBinAll( const QString& MatrixName, QVariant& BinValues )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&BinValues };
	qt_metacall( QMetaObject::InvokeMetaMethod, 156, _a );
...
inline bool
LMOSActX::MoveA( const QString& ObjectName, double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dX, (void*)&dY };
	qt_metacall( QMetaObject::InvokeMetaMethod, 157, _a );
...
inline bool
LMOSActX::PLCCommand( const QString& ID1, const QString& ID2, const QString& Command )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ID1, (void*)&ID2, (void*)&Command };
	qt_metacall( QMetaObject::InvokeMetaMethod, 158, _a );
...
inline bool
LMOSActX::PLCCommandEx( const QString& ID1, const QString& ID2, const QVariant& Command )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ID1, (void*)&ID2, (void*)&Command };
	qt_metacall( QMetaObject::InvokeMetaMethod, 159, _a );
...
inline bool
LMOSActX::ReadByte( LMOSACTXLib::InPortConstants Port, int bMask, int& InByte )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&Port, (void*)&bMask, (void*)&InByte };
	qt_metacall( QMetaObject::InvokeMetaMethod, 160, _a );
...
inline bool
LMOSActX::ReadIOBit( const QVariant& bitfunction, QVariant& Result )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&bitfunction, (void*)&Result };
	qt_metacall( QMetaObject::InvokeMetaMethod, 161, _a );
...
inline void
LMOSActX::RemoveGlobalQPSet( const QString& Name )
{
	void* _a[] = { 0, (void*)&Name };
	qt_metacall( QMetaObject::InvokeMetaMethod, 163, _a );
}
...
inline void
LMOSActX::RemoveLocalQPSet( const QString& Name )
{
	void* _a[] = { 0, (void*)&Name };
	qt_metacall( QMetaObject::InvokeMetaMethod, 164, _a );
}
...
inline bool
LMOSActX::ReplaceDrawing( const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 165, _a );
...
inline bool
LMOSActX::ReplaceGlobalQPSet( const QString& OriginalQPSetName, const QString& NewQPSetName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&OriginalQPSetName, (void*)&NewQPSetName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 166, _a );
...
inline bool
LMOSActX::ReplaceLocalQPSet( const QString& OriginalQPSetName, const QString& NewQPSetName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&OriginalQPSetName, (void*)&NewQPSetName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 167, _a );
...
inline bool
LMOSActX::RotateA( const QString& ObjectName, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dAngle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 168, _a );
...
inline void
LMOSActX::RotateView( double Angle )
{
	void* _a[] = { 0, (void*)&Angle };
	qt_metacall( QMetaObject::InvokeMetaMethod, 169, _a );
}
...
inline bool
LMOSActX::Save( const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 170, _a );
...
inline bool
LMOSActX::SaveAsVersion( const QString& FileName, LMOSACTXLib::LMOSSaveAsVersionConstants SaveVersion )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FileName, (void*)&SaveVersion };
	qt_metacall( QMetaObject::InvokeMetaMethod, 171, _a );
...
inline bool
LMOSActX::SaveImage( int resx, int resy, const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&resx, (void*)&resy, (void*)&FileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 174, _a );
...
inline bool
LMOSActX::SaveImageWithRuler( int resx, int resy, const QString& FileName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&resx, (void*)&resy, (void*)&FileName };
	qt_metacall( QMetaObject::InvokeMetaMethod, 175, _a );
...
inline bool
LMOSActX::SelectShadow( int ShadowIndex )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ShadowIndex };
	qt_metacall( QMetaObject::InvokeMetaMethod, 176, _a );
...
inline bool
LMOSActX::SelectSingleStep( int StepIndex )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&StepIndex };
	qt_metacall( QMetaObject::InvokeMetaMethod, 177, _a );
...
inline void
LMOSActX::SetAxisUsedInVLM( LMOSACTXLib::eAxisType eAxis, bool Value )
{
	void* _a[] = { 0, (void*)&eAxis, (void*)&Value };
...
inline bool
LMOSActX::SetDimension( const QString& ObjectName, double dWidth, double dHeight )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dWidth, (void*)&dHeight };
...
inline bool
LMOSActX::SetGlobalQPSet( const QString& QPSetName, double CURRENT, int SPEED, int FREQUENCY, bool bSave )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&QPSetName, (void*)&CURRENT,
		       (void*)&SPEED,	   (void*)&FREQUENCY, (void*)&bSave };
...
inline bool
LMOSActX::SetHatchParam( const QString&		      hpname,
			 LMOSACTXLib::eHSType	      hstype,
			 LMOSACTXLib::eHatchParamType partype,
			 const QVariant&	      varVal )
{
...
inline bool
LMOSActX::SetHatchProperties( const QString& MOName,
			      bool	     Unidirectional,
			      bool	     Bidirectional,
			      bool	     Meandering,
			      bool	     OnTheFly,
...
inline bool
LMOSActX::SetLaserable( const QString& MOName, bool bFlag )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&bFlag };
...
inline bool
LMOSActX::SetLogo( const QString& ObjectName, const QString& VariableValue )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&VariableValue };
...
inline bool
LMOSActX::SetMODescription( const QString& MOName, const QString& description )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&description };
...
inline bool
LMOSActX::SetMOLayer( const QString& MOName, const QString& LayerName )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MOName, (void*)&LayerName };
...
inline bool
LMOSActX::SetMatrixCellAngle( const QString& MatrixName, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&dAngle };
...
inline bool
LMOSActX::SetMatrixCellOccupation( const QString& MatrixName, int iCellIndex, bool IsOccupied )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&iCellIndex, (void*)&IsOccupied };
...
inline bool
LMOSActX::SetMatrixCellOccupationAll( const QString& MatrixName, QVariant& OccValues )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&OccValues };
...
inline bool
LMOSActX::SetMatrixCellOffset( const QString& MatrixName, int iCellIndex, double OffX, double OffY, double OffPhi )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&iCellIndex,
		       (void*)&OffX,	   (void*)&OffY,       (void*)&OffPhi };
...
inline bool
LMOSActX::SetMatrixMaxBinCount( const QString& MatrixName, int MaxBinCount )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&MaxBinCount };
...
inline bool
LMOSActX::SetMatrixRefCell( const QString& MatrixName, int iIndex, bool bDrawRefCellOnly )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&MatrixName, (void*)&iIndex, (void*)&bDrawRefCellOnly };
...
inline bool
LMOSActX::SetPosValues( const QString& ObjectName, double dX, double dY, double dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&dX, (void*)&dY, (void*)&dAngle };
...
inline bool
LMOSActX::SetQualityParam( const QString&	   qpname,
			   LMOSACTXLib::eQPType	   qptype,
			   LMOSACTXLib::eParamType partype,
			   const QVariant&	   varVal,
			   bool			   bSave )
...
inline bool
LMOSActX::SetRuntimeHeadOffset( double X, double Y, int hindex )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&X, (void*)&Y, (void*)&hindex };
...
inline void
LMOSActX::SetSignal( LMOSACTXLib::eSignalConstants Signal, bool Value )
{
	void* _a[] = { 0, (void*)&Signal, (void*)&Value };
...
inline bool
LMOSActX::SetSurfaceRadius( double radius )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&radius };
...
inline bool
LMOSActX::SetSurfaceRefPoint( double RefX, double RefY, double RefZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&RefX, (void*)&RefY, (void*)&RefZ };
...
inline bool
LMOSActX::SetSurfaceVector( double VecX, double VecY, double VecZ )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&VecX, (void*)&VecY, (void*)&VecZ };
...
inline bool
LMOSActX::SetSystemParameter( LMOSACTXLib::eSystemParameterSet partype, const QVariant& varVal )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&partype, (void*)&varVal };
...
inline bool
LMOSActX::SetText( const QString& ObjectName, const QString& VariableValue )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&VariableValue };
...
inline void
LMOSActX::ShowMatrixCell2( const QString& MatrixName )
{
	void* _a[] = { 0, (void*)&MatrixName };
...
inline bool
LMOSActX::ShowZoomWindow( int topLeftX, int topLeftY, int bottomRightX, int bottomRightY )
{
	bool  qax_result;
	void* _a[] = {
		(void*)&qax_result, (void*)&topLeftX, (void*)&topLeftY, (void*)&bottomRightX, (void*)&bottomRightY
...
inline bool
LMOSActX::SplitDrawing( double offset, double Overlap )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&offset, (void*)&Overlap };
...
inline void
LMOSActX::StartPosHelp( const QString& ObjectName )
{
	void* _a[] = { 0, (void*)&ObjectName };
...
inline void
LMOSActX::StartPosHelpLast( const QString& ObjectName )
{
	void* _a[] = { 0, (void*)&ObjectName };
...
inline bool
LMOSActX::TTLFieldCorr( const QString& FileName, int Action, int Head )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&FileName, (void*)&Action, (void*)&Head };
...
inline bool
LMOSActX::TTLGetAbsPosValues( const QString& ObjectName, int lMatrixCellIndex, double& dX, double& dY, double& dAngle )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ObjectName, (void*)&lMatrixCellIndex,
		       (void*)&dX,	   (void*)&dY,	       (void*)&dAngle };
...
inline bool
LMOSActX::TTLPxCamera( double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY };
...
inline bool
LMOSActX::TTLPxLaser( double dX, double dY )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&dX, (void*)&dY };
...
inline bool
LMOSActX::TermMachineEx( LMOSACTXLib::eMachineModuleConstants ModulesMask )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&ModulesMask };
...
inline IDispatch*
LMOSActX::TextObjects( const QString& MOName )
{
	IDispatch* qax_result = 0;
	void*	   _a[]	      = { (void*)&qax_result, (void*)&MOName };
...
inline bool
LMOSActX::WaitOnByte( LMOSACTXLib::InPortConstants Port, int bMask, int bData, int lTimeOut )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&Port, (void*)&bMask, (void*)&bData, (void*)&lTimeOut };
...
inline bool
LMOSActX::WaitOnIOBit( const QVariant& bitfunction, const QVariant& values, int timeout )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&bitfunction, (void*)&values, (void*)&timeout };
...
inline bool
LMOSActX::WriteByte( LMOSACTXLib::OutPortConstants Port, int bMask, int bData )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&Port, (void*)&bMask, (void*)&bData };
...
inline bool
LMOSActX::WriteIOBit( const QVariant& bitfunction, const QVariant& values )
{
	bool  qax_result;
	void* _a[] = { (void*)&qax_result, (void*)&bitfunction, (void*)&values };
...
inline QVariant
MachineCfg::GetValue( int categoryId, int valueId )
{
	QVariant qax_result;
	void*	 _a[] = { (void*)&qax_result, (void*)&categoryId, (void*)&valueId };
	qt_metacall( QMetaObject::InvokeMetaMethod, 8, _a );
...
inline void
MachineCfg::SetValue( int categoryId, int valueId, const QVariant& Value )
{
	void* _a[] = { 0, (void*)&categoryId, (void*)&valueId, (void*)&Value };
	qt_metacall( QMetaObject::InvokeMetaMethod, 9, _a );
}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IPowerDlg*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IPowerDlg();
	}
	...
	{
		stream << *static_cast<const LMOSACTXLib::IPowerDlg*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ILayers*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ILayers();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ILayers*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ILayer*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ILayer();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ILayer*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::_DLMOSActX*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::_DLMOSActX();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::_DLMOSActX*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IResDesc*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IResDesc();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IResDesc*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IAxis*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IAxis();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IAxis*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IMachineCfg*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IMachineCfg();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IMachineCfg*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::Layer*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::Layer();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::Layer*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::Layers*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::Layers();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::Layers*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ResDesc*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ResDesc();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ResDesc*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::Axis*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::Axis();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::Axis*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::Variable*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::Variable();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::Variable*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IVariable*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IVariable();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IVariable*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::Variables*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::Variables();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::Variables*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IVariables*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IVariables();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IVariables*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::TextObject*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::TextObject();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::TextObject*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ITextObject*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ITextObject();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ITextObject*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::TextObjects*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::TextObjects();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::TextObjects*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ITextObjects*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ITextObjects();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ITextObjects*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ComponentBase*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ComponentBase();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ComponentBase*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IComponentBase*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IComponentBase();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IComponentBase*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::ComponentBases*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::ComponentBases();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::ComponentBases*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IComponentBases*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IComponentBases();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IComponentBases*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::MachineCfgParam*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::MachineCfgParam();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::MachineCfgParam*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IMachineCfgParam*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IMachineCfgParam();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IMachineCfgParam*>( t );
	}
	static void Load( QDataStream& stream, void* t )
	{
		stream >> *static_cast<LMOSACTXLib::IMachineCfgParam*>( t );
	}
#endif	// QT_NO_DATASTREAM
};
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::MachineCfgParams*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::MachineCfgParams();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::MachineCfgParams*>( t );
	}
	static void Load( QDataStream& stream, void* t )
	{
		stream >> *static_cast<LMOSACTXLib::MachineCfgParams*>( t );
	}
#endif	// QT_NO_DATASTREAM
};
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::IMachineCfgParams*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::IMachineCfgParams();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::IMachineCfgParams*>( t );
	}
	static void Load( QDataStream& stream, void* t )
	{
		stream >> *static_cast<LMOSACTXLib::IMachineCfgParams*>( t );
	}
#endif	// QT_NO_DATASTREAM
};
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::PowerDialog*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::PowerDialog();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::PowerDialog*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::LMOSActX*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::LMOSActX();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::LMOSActX*>( t );
	}
...
{
	static void  Delete( void* t ) { delete static_cast<LMOSACTXLib::MachineCfg*>( t ); }
	static void* Create( const void* t )
	{
		Q_ASSERT( !t );
		Q_UNUSED( t )
		return new LMOSACTXLib::MachineCfg();
	}
	static void Destruct( void* t )
	{
		Q_UNUSED( t )
	...
	static void Save( QDataStream& stream, const void* t )
	{
		stream << *static_cast<const LMOSACTXLib::MachineCfg*>( t );
	}
