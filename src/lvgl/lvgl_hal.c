...
// https://bugs.launchpad.net/ubuntu/+source/libsdl2/+bug/1775067/comments/7
	...
	indev_drv_mouse.read_cb = sdl_mouse_read; /*This function will be called periodically (by the library) to get
	...
	indev_drv_mousewheel.read_cb = sdl_mousewheel_read; /*This function will be called periodically (by the library)
					       to get the mousewheel position and state*/
