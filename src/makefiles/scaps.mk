...
SCAPS_SRC  = $(SRC_DIR)/scaps/scaps.c $(WINEPRE)/drive_c/scaps/sam2d/tlb_include/sc_samlight_client_ctrl_ex_type_lib_i.c
...
scaps_run:	$(SCAPS_EXE)
		WINEPREFIX=$(WINEPRE) WINEARCH=$(WINEACH) $(WINEBINARY) $^ 2>/dev/null
