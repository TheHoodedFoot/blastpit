...
class Multipass:
    ...
    def loadAndExecuteVLM(self, filename):
        ...
        print("Waiting for imageEnd2 signal...")
    ...
    def run(self):
        ...
        if self.inputfile is not None:
            ...
            print("Please specify an input filename", file=sys.stderr)
            return False

        if self.outputfile is None:
            print("Please specify an output filename", file=sys.stderr)
            return False
        ...
        print()
        print("REMEMBER TO DELETE ANY NON-MARKED GEOMETRY USED TO CREATE THE EXTRA SHADOW")
        print()
